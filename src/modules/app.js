    ...
    card.innerHTML = `
            <h2 class="title-2 card-title">Now</h2>
                <div class="weapper">
                    ...
                    <img src="src/images/weather_icons/${icon}.png" width="64" height="64" alt="${description}"
                         class="weather-icon" />
                </div>
        ...
        module.aqiText[aqi].message
          ...
          <div class="card card-sm highlights-card">
              ...
              <div class="wrapper">
                  ...
                  <p class="title-1">${pressure}<sup>hPa</sup>
                  </p>
              </div>
          </div>
          <div class="card card-sm highlights-card">
          ...
          <div class="card card-sm highlights-card">
              ...
              <div class="wrapper">
                  ...
                  <p class="title-1">${parseInt(feels_like)}&deg;<sup>c</sup>
                  </p>
              </div>
          </div>
      </div>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="src/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy"
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            <img src="src/images/weather_icons/${icon}.png" width="36" height="36"
                alt="${description}" class="weather-icon" title="${description}">
            <span class="span">
